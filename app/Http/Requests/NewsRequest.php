...
class NewsRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|min:5|unique:news,name',  // Название новости
            'slug' => 'nullable|string|min:5|unique:news,slug',  // Слаг
            'description' => 'required|string',  // Описание новости
            'photo' => 'required|image|mimes:jpg,jpeg,png,gif,webp|max:2048',  // Фото
            'date' => 'required|date', // Дата
        ];
    }
